...
public class Repository {
    ...
    @GET
    @Path("capitani/{id}")
    public GenericResource getCapitani(@PathParam("id")String id){
        GenericResource tmp = new GenericResource();
        tmp.setId("["+id+"] Francesco T O T T I");
        tmp.setName("un go' MERAVIGLIOSO");
